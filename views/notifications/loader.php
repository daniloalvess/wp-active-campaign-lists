<div class="loader">
	...
	<circle cx="84" cy="50" r="7.18019" fill="#5fa2ed">
		...
		<animate attributeName="fill" repeatCount="indefinite" dur="2.2222222222222223s" calcMode="discrete" keyTimes="0;0.25;0.5;0.75;1" values="#3389d8;#3389d8;#5fa2ed;#3389d8;#3389d8" begin="0s"></animate>
	</circle><circle cx="16" cy="50" r="2.81981" fill="#5fa2ed">
	...
	</circle><circle cx="25.5873" cy="50" r="10" fill="#5fa2ed">
	...
	</circle><circle cx="59.5873" cy="50" r="10" fill="#3389d8">
	...
	</circle><circle cx="16" cy="50" r="0" fill="#5fa2ed">
